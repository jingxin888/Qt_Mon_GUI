...
#define GenericApp_GAN_CLUSTERID          2     //烟雾ID
#define GENERICAPP_wenshidu_CLUSTERID     3     
#define GenericApp_Guangqiang_CLUSTERID   4     //光强ID
#define GenericApp_wendu_CLUSTERID        5     //温度id
#define GenericApp_rentihongwai_CLUSTERID        6   //人体红外id
